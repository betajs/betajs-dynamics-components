...
Scoped.define("module:List", [
    ...
    return Dynamic.extend({
        ...
        /**/"!!loadmore && loadmorestyle !== 'infinite' && loadmorebackwards": function (obj) { with (obj) { return !!loadmore && loadmorestyle !== 'infinite' && loadmorebackwards; } }, "!loading && !!loadmore && loadmorestyle !== 'infinite' && loadmorebackwards": function (obj) { with (obj) { return !loading && !!loadmore && loadmorestyle !== 'infinite' && loadmorebackwards; } }, "loadmorebackwards && loading": function (obj) { with (obj) { return loadmorebackwards && loading; } }, "(model.listcollection||listcollection)": function (obj) { with (obj) { return (model.listcollection||listcollection); } }, "infinite_scroll_options": function (obj) { with (obj) { return infinite_scroll_options; } }, "drop_list_options": function (obj) { with (obj) { return drop_list_options; } }, "getview(collectionitem)": function (obj) { with (obj) { return getview(collectionitem); } }, "!!collectionitem.experimental": function (obj) { with (obj) { return !!collectionitem.experimental; } }, "collectionitem.cid()": function (obj) { with (obj) { return collectionitem.cid(); } }, "collectionitem.pid()": function (obj) { with (obj) { return collectionitem.pid(); } }, "selection": function (obj) { with (obj) { return selection; } }, "droplist": function (obj) { with (obj) { return droplist; } }, "collectionitem.callbacks": function (obj) { with (obj) { return collectionitem.callbacks; } }, "itemContext(collectionitem)": function (obj) { with (obj) { return itemContext(collectionitem); } }, "isEqual(collectionitem, selected)": function (obj) { with (obj) { return isEqual(collectionitem, selected); } }, "[collectionitem]": function (obj) { with (obj) { return [collectionitem]; } }, "collectionitem.view||view.listinner||{}": function (obj) { with (obj) { return collectionitem.view||view.listinner||{}; } }, "collectionitem": function (obj) { with (obj) { return collectionitem; } }, "itemattrs": function (obj) { with (obj) { return itemattrs; } }, "!!loadmore && loadmorestyle !== 'infinite' && loadmoreforwards": function (obj) { with (obj) { return !!loadmore && loadmorestyle !== 'infinite' && loadmoreforwards; } }, "!loading && collection_count > 0 && !!loadmore && loadmorestyle !== 'infinite' && loadmoreforwards": function (obj) { with (obj) { return !loading && collection_count > 0 && !!loadmore && loadmorestyle !== 'infinite' && loadmoreforwards; } }, "loading": function (obj) { with (obj) { return loading; } }, "emptymessage && !loading && collection_count === 0": function (obj) { with (obj) { return emptymessage && !loading && collection_count === 0; } }, "emptymessage": function (obj) { with (obj) { return emptymessage; } }, "emptymessage && !loading && collection_count === 0 && refreshable": function (obj) { with (obj) { return emptymessage && !loading && collection_count === 0 && refreshable; } }/**/
    }).register();
